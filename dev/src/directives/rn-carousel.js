(function () {
    ...
    angular.module('angular-carousel').directive('rnCarousel', [
        '$swipe', '$window', '$document', '$parse', '$compile', '$rootScope', function ($swipe, $window, $document, $parse, $compile, $rootScope) {
            // internal ids to allow multiple instances
            var carouselId = 0, timeConstant = 75, moveTreshold = 0.05, rubberTreshold = 3;
            ...
            return {
                ...
                compile: function (tElement, tAttributes) {
                    ...
                    var firstChildAttributes = tElement.children()[0].attributes, isRepeatBased = false, isBuffered = false, slidesCount = 0, isIndexBound = false, repeatItem, repeatCollection;
                    ...
                    return function (scope, iElement, iAttributes, containerCtrl) {
                        ...
                        var containerWidth, transformProperty, pressed, startX, amplitude, offset = 0, destination, slidesCount = 0, swipeMoved = false, timestamp;

                        // add a wrapper div that will hide the overflow
                        var carousel = iElement.wrap("<div id='carousel-" + carouselId + "' class='rn-carousel-container'></div>"), container = carousel.parent();
                        ...
                        function swipeEnd(coords, event, forceAnimation) {
                            ...
                            var minMove = getAbsMoveTreshold(), currentOffset = (scope.carouselIndex * containerWidth), absMove = currentOffset - destination, slidesMove = -Math[absMove >= 0 ? 'ceil' : 'floor'](absMove / containerWidth), shouldMove = Math.abs(absMove) > minMove;
...
//# sourceMappingURL=rn-carousel.js.map
